<template>
  <footer class="footer px-4 navbar-fixed-bottom">
    <b-row align-v="center" class="justify-content-lg-between">
      <b-col lg="6">
        <div class="copyright text-center text-lg-left text-muted">
          © {{year}} <a href="https://github.com/DavidGina306/contacts" class="font-weight-bold ml-1" target="_blank">Full Contacts</a>
        </div>
      </b-col>
      <!-- <b-col lg="6">
