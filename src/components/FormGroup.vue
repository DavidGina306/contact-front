<template>
    <fieldset @change="clearError" class="form-group" ref="field">
        <legend v-if="label" :data-legend="fieldName" tabindex="-1" class="bv-no-focus-ring d-block form-control-label col-form-label pb-1 pt-0">
            <label class="mb-0">{{label}} <span v-if="required" class="text-danger">*</span></label>
